package com.nisa.quranapp.detail
...
import com.nisa.quranapp.adapter.AyatAdapter
...
class DetailSurahActivity : AppCompatActivity() {
    ...
    private fun showListAyat() {
        ayatAdapter = modelAyat?.let {
            AyatAdapter(this@DetailSurahActivity,
                it
            )
        }
